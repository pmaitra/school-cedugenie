...
<span id="proceeFlowHeader" style="margin-left: 10%;">ERP Process Flow</span>
    <div class="simpleLens-gallery-container" id="demo-1">
        <div class="simpleLens-container">
            <div class="simpleLens-big-image-container">
                <a class="simpleLens-lens-image" data-lens-image="/cedugenie/images/ERPFlowDiagrm.png">
                    <img src="/cedugenie/images/ERPFlowDiagrm.png" class="simpleLens-big-image">
                </a>
            </div>
        </div>        
    </div>
