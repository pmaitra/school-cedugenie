...
<form id="erpNavigation" name="erpNavigation" action="changeRoleForUser.html" method="post">
    ...
    <section class="bodyarea">    
        ...
        <article class="leftcon">        
			...
			<div class="arrowlistmenu">
                ...
                <a href="notificationPage.html" target="_self" style="color: yellow; font-weight: bolder; text-decoration: none; "><h3 class="menuheader" style="background:url('/icam/images/a.jpg');"><i class="icon icon-home"></i>&nbsp;&nbsp;<span style="color:white;">HOME -> </span> <span style="color:#9fda58">ERP</span></h3></a>
				...
				<c:if test="${i eq 1}">
	                <h3 class="menuheader expandable">Staff Set up</h3>
				...
				<c:if test="${i eq 1}">
	                <h3 class="menuheader expandable">Payment Set Up</h3>
	                <ul class="categoryitems">
	                	<c:forEach var="functionality" items="${role.functionalityList}" >
							<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Salary Template')}">
							<c:if  test="${functionality.insert eq true}">
                ...
                <c:if test="${i eq 1}">
					<h3 class="menuheader expandable">Employee Details</h3>
	                <ul class="categoryitems"> 						
						<c:forEach var="functionality" items="${role.functionalityList}" >
							<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Enter Employee Details')}">
							<c:if  test="${functionality.insert eq true}">
				...
				<c:if test="${i eq 1}">
	                ...
	                <ul class="categoryitems">
<%-- 	                	<c:forEach var="functionality" items="${role.functionalityList}" > --%>
<%-- 							<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Request for Leave')}"> --%>
<%-- 							<c:if  test="${functionality.insert eq true}"> --%>
...
<%-- 						</c:forEach>					 --%>
				...
				<c:if test="${i eq 1}">
					 <h3 class="menuheader expandable">Retirement</h3>
	                <ul class="categoryitems">	                
	                	<c:forEach var="functionality" items="${role.functionalityList}" >
							<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Staff Retirement')}">
							<c:if  test="${functionality.insert eq true}">
        ...
        <aside class="rightcon"> 
            ...
            <div class="innercon">            
            	<div class="boxcon">
					<iframe src="erpProcessFlow.html" name="frame" id="frame" onload='javascript:resizeIframe(this);'>
