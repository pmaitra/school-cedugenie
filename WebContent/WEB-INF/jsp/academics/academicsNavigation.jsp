													...
													<ul class="nav nav-children">																									
															<li class="nav-parent">
																...
																<ul class="nav nav-children">	
																	...
																	<li><a href="getCourse.html" target="frame">Create Course</a></li>
																	...
																	<li><a href="getCourseSubjectMapping.html" target="frame">Course Subject Mapping</a></li>
																</ul>
															</li>
															<li class="nav-parent">
																<a>
															...
															<li class="nav-parent">
																...
																<ul class="nav nav-children">
																	...
																	<li><a href="studentCourseSubjectMapping.html?link=create" target="frame">Create Student Course Subject Mapping</a></li>
																	<li><a href="studentCourseSubjectMapping.html?link=edit" target="frame">Edit Student Course Subject Mapping</a></li>
																</ul>
															</li>
