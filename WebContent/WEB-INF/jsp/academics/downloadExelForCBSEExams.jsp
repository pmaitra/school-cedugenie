...
<title>Upload CBSE Result</title>

<link rel="stylesheet" href="/cedugenie/css/academics/downloadExelForCBSEExams.css" />
...
<script type="text/javascript" src="/cedugenie/js/academics/downloadExelForCBSEExams.js"></script> 
...
<div class="ttlarea">	
	<h1>
		<img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp;Upload CBSE Result
		<div style="float: right;">
			<div style="float: right; position: relative;margin-bottom: 1%;">
				<form id="safcontents" name="safcontents" action="uploadExelForCBSEExam.html" method="POST" enctype="multipart/form-data">
					<span id="FileUpload">
	...
	<form name="subjectForm" id="subjectForm" method="POST" action="downloadExelForCBSEExams.html" >
		<c:choose>
...
<%-- 								</c:forEach> --%>
				...
				<div class="btnsarea01" id="btnDiv" style="visibility: collapse;">
					<input type="submit" onclick="return downloadExel();" value="Download Exel" class="submitbtn"/>
				</div>
			</c:otherwise>	
		</c:choose>
	</form>
