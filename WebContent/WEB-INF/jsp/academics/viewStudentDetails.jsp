...
<link rel="stylesheet" href="/cedugenie/css/backoffice/editStudent.css" />
...
<div class="ttlarea">	
	<h1>
		<img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp; Student Details
	</h1>
</div>
		...
		<table cellspacing="0" cellpadding="0" class="midsec"  >			
			<tr>
				<th>Roll Number <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
		...
		<table cellspacing="0" cellpadding="0" class="midsec">
			<tr>
				<th>First Name <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
				...
				<th>Last Name <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
				<td><input class="textfield1" type="text" name="resource.lastName" value="${student.resource.lastName}" id="lastName" /></td>		
			</tr>
			<tr>								
				<th>Standard <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
				<td>
				...
				<th>House <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
				<td>
			...
			<tr>								
				<th>DOB <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
				<td><input class="textfield1" name="resource.dateOfBirth" value="${student.resource.dateOfBirth}" id="dateOfBirth" ></td>
				<th>Admission Date <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
				<td><input class="textfield1" name="dateOfAdmission" value="${student.dateOfAdmission}" id="dateOfAdmission" ></td>
				<th>State Of Domicile <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
				<td>
					<select id="stateOfDomicile" name="stateOfDomicile" class="defaultselect">
						<c:forEach var="state" items="${stateList}" >
							<option value="${state.stateCode}" ${state.stateName eq student.stateOfDomicile ? 'selected=selected' : ''}>${state.stateName}</option>
						</c:forEach>
					</select>
				</td>
			</tr>			
			...
			<tr>
				<th>Second Language <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
				<td>
		...
		<table cellspacing="0" cellpadding="0" class="midsec">
			...
			<tr>
				<th>Address1 <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
			...
			<tr>				
				...
				<th>City/Village <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
			...
			<tr>
				...
				<th>Pin code <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
			...
			<tr>
				<th>District <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
				...
				<th>State <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
				<td>
				...
				<th>Country <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>				
				<td>
