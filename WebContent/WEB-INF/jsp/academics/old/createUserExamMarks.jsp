...
<title>Set User Defined Exam Marks</title>

<link rel="stylesheet" href="/icam/css/academics/createUserExamMarks.css" />
...
<script type="text/javascript" src="/icam/js/academics/createUserExamMarks.js"></script> 
...
<div class="ttlarea">	
	<h1>
		<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;Set User Defined Exam Marks
	</h1>
</div>
	...
	<form name="subjectForm" id="subjectForm" method="POST" action="editUserExamMarks.html" >
		<c:choose>
			...
			<c:otherwise>			
				...
				<table id="subjectMarksTable" class="midsec1" cellspacing="0" cellpadding="0" style="visibility: collapse;">
