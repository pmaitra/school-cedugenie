...
<c:url value="/academicsAssetListPagination.html" var="pagedLink">
...
<link rel="stylesheet" href="/icam/css/academics/assetList.css" />
		...
		<table  id="commodityTable" cellspacing="0" cellpadding="0" class="midsec1">
			...
			<c:forEach var="asset" items="${assetPagedListHolder.pageList}" varStatus="i">
				<tr>
					...
					<td>
						<input type="button" value="EDIT DETAILS" id="editDetails" class="greenbtn" onclick="window.open('getAcademicsAssetDetails.html?assetID=${asset.assetId}','_self')">
					</td>
					<td>
			...
			<tr>
				<td colspan="8" id="toolbar"><c:out value="Displaying ${first} to ${last} of ${total} items"/><tg:paging pagedListHolder="${assetPagedListHolder}" pagedLink="${pagedLink}"/></td>
			</tr>
		</table>
		<div class="btnsarea01">
