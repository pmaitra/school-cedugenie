...
<c:url value="/studentsListPagination.html" var="pagedLink">
		...
		<form:form id="studentListForm" name="studentListForm" action="getStudentDetailsToView.html" method="POST">
			...
			<table  id="candidateTable" cellspacing="0" cellpadding="0" class="midsec1">
				...
				<c:forEach var="student" items="${pagedListHolder.pageList}">
					<tr onClick="window.open('getStudentDetailsToView.html?rollNumber=${student.rollNumber}','_self')" style="cursor:pointer;">
