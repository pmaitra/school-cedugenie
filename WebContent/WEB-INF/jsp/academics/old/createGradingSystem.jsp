...
<link rel="stylesheet" href="/icam/css/academics/createGradingSystem.css" />
...
<script type="text/javascript" src="/icam/js/academics/createGradingSystem.js"></script> 
...
<div class="ttlarea">	
	<h1>
		<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;Grading System
	</h1>
</div>
	...
	<form name="subjectForm" id="subjectForm" method="POST" action="editGradingSystem.html" >
		<c:choose>
			...
			<tr><td colspan="2">
				...
				<table cellspacing="0" cellpadding="0" class="midsec1">
					...
					<tr><th colspan="3">(Grading On 9 Point Scale)</th></tr>					
					<tr>
						<th>Marks Range</th>
						<th>Grade</th>
						<th>Grade Point</th>
					...
					<tr>
						<td>21 - 32<input type="hidden" name="Srange" value="21-32"></td>
						<td><input type="text" class="textfield1" name="Sgrade21-32" id="Sgrade21-32"></td>
						<td><input type="text" class="textfield1" name="Spoint21-32" id="Spoint21-32"></td>
					</tr>
					<tr>
						<td>0 - 20<input type="hidden" name="Srange" value="0-20"></td>
						<td><input type="text" class="textfield1" name="Sgrade0-20" id="Sgrade0-20"></td>
				...
				<table  id="" cellspacing="0" cellpadding="0" class="midsec1">
					...
					<tr><th colspan="3">(Grading On 5 Point Scale)</th></tr>
					<tr>
