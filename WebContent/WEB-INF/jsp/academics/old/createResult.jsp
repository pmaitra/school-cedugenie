...
<link rel="stylesheet" href="/icam/css/academics/createResult.css" />
...
<script type="text/javascript" src="/icam/js/academics/createResult.js"></script> 
...
<div class="ttlarea">	
	<h1>
		<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;Upload Result
	</h1>
</div>
	...
	<form name="subjectForm" id="subjectForm" method="POST" action="editStudentResult.html" >
		<c:choose>
