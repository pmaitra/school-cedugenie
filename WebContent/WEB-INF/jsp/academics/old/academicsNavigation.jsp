...
<form id="academicsNavigation" name="academicsNavigation" action="changeRoleForUser.html" method="post">		
<!-- End Of modal content -->
<section class="wrapper">
   ...
   <section class="bodyarea">    
        ...
        <article class="leftcon">        
			...
			<div class="arrowlistmenu">				
                <a href="notificationPage.html" target="_self" style="color: yellow; font-weight: bolder; text-decoration: none; ">
	                ...
	                <i class="icon icon-home"></i>&nbsp;&nbsp;<span style="color:white;">HOME -> </span> <span style="color:#9fda58">Academics</span></h3>
                </a>              
                <c:set var="i" value="0" scope="page" />
                <c:forEach var="functionality" items="${role.functionalityList}" >
					<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Standard')
					||  fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Subject Group')
					||  fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Subject')
					||  fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Class Subject Mapping')}">
                ...
                <c:if test="${i eq 1}">
                <h3 class="menuheader expandable">Configure Standard &amp; Subject</h3>
                <ul class="categoryitems">					
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Standard')}">
							<c:if  test="${functionality.insert eq true}">					
								<li><a href="getStandard.html" target="frame">Create Standard</a></li>
							</c:if>
						</c:if>
					</c:forEach>
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Subject Group')}">
							<c:if  test="${functionality.insert eq true}">					
								<li><a href="getSubjectGroup.html" target="frame">Create Subject Group</a></li>
							</c:if>
						</c:if>
					</c:forEach>
					<c:forEach var="functionality" items="${role.functionalityList}" >
					...
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Standard Subject Mapping')}">
							<c:if  test="${functionality.insert eq true}">					
								<li><a href="getClassSubjectMapping.html" target="frame">Standard Subject Mapping</a></li>
							</c:if>
						</c:if>
					</c:forEach>
                </ul>
               	...
               	<c:set var="i" value="0" scope="page" />
					...
					||  fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Co-Scholastic Result List')
					...
					||  fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Student Result Activity Log')
                ...
                <c:if test="${i eq 1}">
                <h3 class="menuheader expandable">Examination</h3>
                <ul class="categoryitems">					
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Grading System')}">
							<c:if  test="${functionality.insert eq true}">					
								<li><a href="getGradingSystem.html" target="frame">Create Grading System</a></li>
							</c:if>
						</c:if>
					</c:forEach>
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Set Exam Marks')}">
							<c:if  test="${functionality.insert eq true}">					
								<li><a href="getExamMarks.html" target="frame">Set Exam Marks</a></li>
							</c:if>
						</c:if>
					</c:forEach>
					<c:forEach var="functionality" items="${role.functionalityList}" >
					...
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Co-Scholastic Result List')}">
							<c:if  test="${functionality.insert eq true}">					
								<li><a href="getCoScholasticResultList.html" target="frame">Co-Scholastic Result List</a></li>
							</c:if>
						</c:if>
					</c:forEach>	
					<c:forEach var="functionality" items="${role.functionalityList}" >
                ...
                <c:forEach var="functionality" items="${role.functionalityList}" >
					<c:if test="${ fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('List Student')
								...
								|| fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Student Subject Mapping List')							
				...
				<c:if test="${i eq 1}">
	                ...
	                <ul class="categoryitems">
						<c:forEach var="functionality" items="${role.functionalityList}" >
							<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('List Student')}">
								<c:if  test="${functionality.insert eq true}">
		                			<li><a href="viewStudentList.html" target="frame">List Student</a></li>
		                		</c:if>
							</c:if>
						</c:forEach>
						
						<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Student Subject Mapping List')}">
							<c:if  test="${functionality.insert eq true}">		                			
	                			<li><a href="getStudentSubjectMappingList.html" target="frame">Student Subject Mapping List</a></li>
	                		</c:if>
	                	</c:if>
					</c:forEach>
				...
				<c:set var="i" value="0" scope="page" />
               	 <c:forEach var="functionality" items="${role.functionalityList}" >
					<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Assign Section')}">
						<c:if  test="${functionality.update eq true || functionality.insert eq true || functionality.view eq true}">
							<c:set var="i" value="1" scope="page" />
						</c:if>
					</c:if>
                ...
                <c:if test="${i eq 1}">
                <h3 class="menuheader expandable">Assign Section</h3>
                <ul class="categoryitems">					
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Assign Section')}">
							<c:if  test="${functionality.insert eq true}">					
               ...
               <c:set var="i" value="0" scope="page" />
                ...
                <c:if test="${i eq 1}">
                <h3 class="menuheader expandable">User Defined Exams</h3>
                <ul class="categoryitems">					
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create User Defined Exams')}">
							<c:if  test="${functionality.insert eq true}">					
               ...
               <c:set var="i" value="0" scope="page" />
               	 <c:forEach var="functionality" items="${role.functionalityList}" >
					<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('CBSE Exams')				
					||  fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('User Defined Exams')}">
						<c:if  test="${functionality.update eq true || functionality.insert eq true || functionality.view eq true}">
							<c:set var="i" value="1" scope="page" />
						</c:if>
					</c:if>
				...
				<c:if test="${i eq 1}">
                <h3 class="menuheader expandable">Upload Result By Excel</h3>
                <ul class="categoryitems">					
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('CBSE Exams')}">
							<c:if  test="${functionality.insert eq true}">					
								<li><a href="getDownloadExelForCBSEExams.html" target="frame">CBSE Exams</a></li>
							</c:if>
						</c:if>
					</c:forEach>
					
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('User Defined Exams')}">
							<c:if  test="${functionality.insert eq true}">
								<li><a href="getDownloadExelForUserDefinedExams.html" target="frame">User Defined Exams</a></li>
							</c:if>
						</c:if>
					</c:forEach>
				</ul>
               ...
               <c:set var="i" value="0" scope="page" />
                ...
                <c:if test="${i eq 1}">
                <h3 class="menuheader expandable">Asset</h3>
                <ul class="categoryitems">					
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Asset Details')}">
							<c:if  test="${functionality.insert eq true}">					
								<li><a href="createAcademicsAssetDetails.html" target="frame">Asset Details</a></li>
							</c:if>
						</c:if>
					</c:forEach>
					...
					<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Asset List')}">
							<c:if  test="${functionality.insert eq true}">
								<li><a href="viewAcademicsAssetList.html" target="frame">Asset List</a></li>
							</c:if>
						</c:if>
					</c:forEach>
		       </ul>
               ...
               <c:set var="i" value="0" scope="page" />
               <c:forEach var="functionality" items="${role.functionalityList}" >
					<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Annual Stock Verification')
		       ...
		       <c:if test="${i eq 1}">   
                  <h3 class="menuheader expandable">Physics Lab ASTB</h3>
                  <ul class="categoryitems">
                  	<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Annual Stock Verification')}">
							<c:if  test="${functionality.insert eq true}">
                  				<li><a href="createASTV.html?department=PHYSICS LAB" target="frame">Create ASTB</a></li>
	                  		</c:if>
	                  	</c:if>
                  	</c:forEach>                  	
	              	...
	              	<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Condemnation')}">
							<c:if  test="${functionality.insert eq true}">
	                  			<li><a href="createUpdateCondemnation.html?department=PHYSICS LAB" target="frame">Condemnation</a></li>
		               		</c:if>
		               	</c:if>
	               </c:forEach>
                  </ul>
               ...
               <c:if test="${i eq 1}">   
                  <h3 class="menuheader expandable">Chemistry Lab ASTB</h3>
                  <ul class="categoryitems">
                  	<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Annual Stock Verification')}">
							<c:if  test="${functionality.insert eq true}">
                  				<li><a href="createASTV.html?department=CHEMISTRY LAB" target="frame">Create ASTB</a></li>
	                  		</c:if>
	                  	</c:if>
                  	</c:forEach>                  	
	              	...
	              	<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Condemnation')}">
							<c:if  test="${functionality.insert eq true}">
	                  			<li><a href="createUpdateCondemnation.html?department=CHEMISTRY LAB" target="frame">Condemnation</a></li>
		               		</c:if>
		               	</c:if>
	               </c:forEach>
                  </ul>
               ...
               <c:if test="${i eq 1}">   
                  <h3 class="menuheader expandable">Biology Lab ASTB</h3>
                  <ul class="categoryitems">
                  	<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Annual Stock Verification')}">
							<c:if  test="${functionality.insert eq true}">
                  				<li><a href="createASTV.html?department=BIOLOGY LAB" target="frame">Create ASTB</a></li>
	                  		</c:if>
	                  	</c:if>
                  	</c:forEach>                  	
	              	...
	              	<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Condemnation')}">
							<c:if  test="${functionality.insert eq true}">
	                  			<li><a href="createUpdateCondemnation.html?department=BIOLOGY LAB" target="frame">Condemnation</a></li>
		               		</c:if>
		               	</c:if>
	               </c:forEach>
                  </ul>
               ...
               <c:if test="${i eq 1}">   
                  <h3 class="menuheader expandable">Computer Lab ASTB</h3>
                  <ul class="categoryitems">
                  	<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Create Annual Stock Verification')}">
							<c:if  test="${functionality.insert eq true}">
                  				<li><a href="createASTV.html?department=COMPUTER LAB" target="frame">Create ASTB</a></li>
	                  		</c:if>
	                  	</c:if>
                  	</c:forEach>                  	
	              	...
	              	<c:forEach var="functionality" items="${role.functionalityList}" >
						<c:if test="${fn:toLowerCase(functionality.functionalityName) eq fn:toLowerCase('Condemnation')}">
							<c:if  test="${functionality.insert eq true}">
	                  			<li><a href="createUpdateCondemnation.html?department=COMPUTER LAB" target="frame">Condemnation</a></li>
		               		</c:if>
		               	</c:if>
	               </c:forEach>
                  </ul>
        ...
        <aside class="rightcon"> 
            ...
            <div class="innercon">            
            	<div class="boxcon">
					<iframe src="academicsProcessFlow.html" name="frame" id="frame" onload='javascript:resizeIframe(this);'>
