...
<link rel="stylesheet" href="/cedugenie/css/finance/designationSalaryDetails.css" />
...
<script src= "/cedugenie/js/finance/designationSalaryDetails.js" type="text/javascript"></script>
</head>
<body>
<div class="ttlarea">	
		<h1>
		<img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp;Designation Salary Details
		</h1>
</div>
...
<form:form method="POST" action="saveDesignationSalaryDetails.html">
	...
	<tr>
		<th>Designation<img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
		<td>
