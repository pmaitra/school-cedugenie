...
<body>
	<header class="page-header">
		<h2>Payment Done Transactions List</h2>
	</header>
<c:choose>
	<c:when test="${transactionalWorkingAreaListOfDonePayments == null}">
		<div class="infomsgbox" id="infomsgbox" style="visibility:visible;">
			<span id="infomsg">Payment Done Transaction Working Area List Not Found</span>
		</div>
	</c:when>
<c:otherwise>
			...
			<section role="main" class="content-body">		
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Payment Done Transactions List</h2>
							</header>
							...
							<input class = "form-control" type ="hidden" value = "" name = "saveId" id = "saveId" readonly>
								<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="/icam/assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
									...
									<tbody>
										<c:forEach var="twa" items="${transactionalWorkingAreaListOfDonePayments}" varStatus="i">
											<tr class="gradeC">
												<td>
													${twa.department}
												</td>
