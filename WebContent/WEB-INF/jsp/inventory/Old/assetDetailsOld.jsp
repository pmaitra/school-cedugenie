...
<title>Edit Inventory Asset Details</title>
...
<script type="text/javascript" src="/icam/js/inventory/assetDetails.js"></script>
...
<body>
	<div class="ttlarea">	
		<h1>
			<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;Edit Asset Details
		</h1>
	</div>
	...
	<form:form name="assetDetails" method="POST" action="updateAssetDetails.html">				
