...
<link rel="stylesheet" href="/icam/css/inventory/addAssetDetails.css" />
...
<script type="text/javascript" src="/icam/js/inventory/addAssetDetails.js"></script>
...
<body>
	<div class="ttlarea">	
		<h1>
			<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;New Asset Details
			<div style="float: right;">
			<div style="float: left; position: relative;">
				<a class="bookDetails" href="downloadInventoryAssetDetailsExcel.html">
			...
			<div style="float: right; position: relative;margin-bottom: 1%;">
				<form:form id="safcontents" name="safcontents" method="POST" action="uploadInventoryAssetDetailsExcel.html" enctype="multipart/form-data">
					<span id="FileUpload">
	...
	<c:if test="${failStatus != null}">
			<div class="errorbox" id="errorbox" style="visibility: visible;">
				<span id="errormsg">Could not Add Asset. Problem Occured.</span>	
			</div>
	</c:if>
	
	<form:form name="assetDetails" method="POST" action="addAssetDetails.html">				
		<table cellspacing="0" cellpadding="0" class="midsec">
				...
				<td colspan="3">
					<select name="department.departmentCode" id="departmentName" class="defaultselect" >
						...
						<c:forEach var="dept" items="${departmentList}">
							<c:if test="${dept.departmentName eq 'INVENTORY'}">
			...
			<tr>
				<th>Asset Type<img class="required" src="/icam/images/required.gif" alt="Required"></th>
				<th>::</th>
				<td colspan="3">
			...
			<tr>
				<th>Asset Sub Type<img class="required" src="/icam/images/required.gif" alt="Required"></th>
				<th>::</th>
				<td colspan="3">
