...
<title>Inventory Master Session</title>
...
<link href="/icam/css/inventory/createInventorySession.css" rel="stylesheet" />

<script type="text/javascript" src="/icam/js/common/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/icam/js/common/jquery-ui.min.js"></script>
<script src="/icam/Cal/zebra_datepicker.js"></script>
<script type="text/javascript" src="/icam/js/inventory/createInventorySession.js"></script>
<script>
...
<div class="ttlarea">	
	<h1>
		<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;Inventory Session		
	</h1>
</div>
<form:form method="POST" id="addInventorySession" name="addInventorySession" action="updateInventorySession.html" >
	...
	<table cellspacing="0" cellpadding="0" class="midsec" id="inventorySessionTable">
		<c:forEach var="academicYear" items="${inventorySessionList}">
		...
		<c:forEach var="academicYear" items="${inventorySessionList}">
			<c:if test="${academicYear.yearStatus eq 'NEXT'}">
				<tr>
					<th colspan="2">Next Inventory Master Session Is <b>${academicYear.academicYearName}</b></th>
				</tr>
			</c:if>
		</c:forEach>
	</table>
