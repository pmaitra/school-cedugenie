...
<script type="text/javascript" src="/icam/js/inventory/inventoryPurchaseOrderDetails.js"></script>
</head>
<body>
<div class="ttlarea">	
...
<c:choose>
	...
	<form:form id="purchaseOrderDetails" name="purchaseOrderDetails" action="submitPurchaseOrderDetails.html" method="POST">
		...
		<table  id="purchaseOrderTable" cellspacing="0" cellpadding="0" class="midsec1">
			...
			<tr>
				<td>
					...
					<input type="hidden"  name="purchaseOrderId" value="${purchaseOrder.purchaseOrderCode}" readonly="readonly">
				</td>
				<td>
