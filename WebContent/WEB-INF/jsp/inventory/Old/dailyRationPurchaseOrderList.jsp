...
<c:url value="/dailyRationPurchaseOrderListPagination.html" var="pagedLink">
...
<link rel="stylesheet" href="/icam/css/inventory/dailyRationPurchaseOrderList.css" />
...
<script type="text/javascript" src="/icam/js/inventory/dailyRationPurchaseOrderList.js"></script>
</head>
<body>
<div class="ttlarea">	
	<h1><img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;Daily Ration Purchase Order List
	</h1>
</div>
<c:choose>
	...
	<form:form id="searchDailyRationPurchaseOrder" name="searchDailyRationPurchaseOrder" action="searchDailyRationPurchaseOrder.html" method="POST">
		...
		<table  id="purchaseOrderTable" cellspacing="0" cellpadding="0" class="midsec1">
			...
			<c:forEach var="purchaseOrder" items="${purchaseOrderPagedListHolder.pageList}" varStatus="i">
				<tr>
					...
					<td>
						<a class="hlink" onClick="window.open('dailyRationPurchaseOrderDetails.html?dailyRationPurchaseOrderCode=${purchaseOrder.purchaseOrderId}','_self')" style="cursor:pointer;"> details</a>
					</td>
				</tr>
			</c:forEach>
			<tr>
