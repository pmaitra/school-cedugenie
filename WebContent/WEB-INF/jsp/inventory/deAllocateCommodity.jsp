			...
			<div class = "content-padding">
				<!-- start: page -->
					<div class="row">
						...
						<c:otherwise>
						<form id="deAllotCommodity" name="deAllotCommodity" action="deAllotCommodity.html" method="post">	
							<div class="col-md-4 col-md-offset-4">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">De-Allocate Commodity</h2>										
									</header>
									<div style="display: block;" class="panel-body">
										<div class="form-group">
											<label class="control-label">Return To</label>
											<input type="text" id="returnedTo" name="returnedTo" value="${deAllocatedBy}" readonly class="form-control" placeholder="" >
										</div>
										<div class="form-group">
...
<script type="text/javascript" src="/cedugenie/js/inventory/deAllocateCommodity.js"></script>
</body>
</html>