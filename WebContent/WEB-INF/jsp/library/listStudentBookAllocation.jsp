							...
							<section class="panel">
								...
								<div style="display: block;" class="panel-body">
                                    <div class="form-group">
										...
										<input type="text" class="form-control" disabled name="bookRequestedId" value="${bookRequestList.bookRequestCode}"/>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">User ID</label>
										<input type="text" class = "form-control" disabled name="userId" value="${bookRequestList.bookRequestFor.userId}"/>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Name</label>
                                        <input type="text" class="form-control" disabled value="${bookRequestList.bookRequestFor.firstName} ${bookRequestList.bookRequestFor.middleName} ${bookRequestList.bookRequestFor.lastName}">
                                    </div>
								</div>
							</section>
						</div>
