                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="accessTypeName" id="accessTypeName" value="${accessTypeDetails.accessTypeName}" placeholder="" pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" title="The full name can consist of alphabetical characters and spaces only" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea maxlength="250" data-plugin-maxlength="" rows="3" name="accessTypeDesc" id="accessTypeDesc" class="form-control" pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" title="The full name can consist of alphabetical characters and spaces only" >${accessTypeDetails.accessTypeDesc}</textarea>
                                                </div> 
                                            </div>
                                            <div class="col-md-6">
