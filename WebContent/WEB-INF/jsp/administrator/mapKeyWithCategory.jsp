...
<body>
	<header class="page-header">
			<h2>Create Category Key Mapping</h2>
		</header>
			...
			<div class="row">
 					<div class="row">
						<div class="col-md-6 col-md-offset-3">
						  <form:form method="POST" id="insertCategoryKeyMapping" name="insertCategoryKeyMapping" action="insertCategoryKeyMapping.html" >
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Create Category Key Mapping</h2>										
									</header>
									...
									<div style="display: block;" class="panel-body">
                                       ...
                                       <div class ="row">
                                    	...
                                    	<tbody id="keyCategoryTableBody">
                                    		<tr>
                                    			<td>
                                    				<input type = "text" class="form-control" name="jobTypeCode" id="jobTypeCode0" required>
                           ...
                           <%--  <form:form id="editServiceType" name="editServiceType" action="updateServicetype.html" method="post"> --%>
							...
							<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										<c:forEach var="category" items="${categoryKeyList}" varStatus="rowCount">
										<tr>											
											<td>
												
												<input type="text" class="form-control" name="category${rowCount.index}" value="${category.ticketDesc}" id="category${rowCount.index}" readonly>
											</td>
											
                                           
											<td class="actions">
												<a href = "getCategoryKeyMapping.html?categoryCode=${category.ticketCode}" class="mb-xs mt-xs mr-xs btn btn-info">Details</a>
											</td>
										</tr>
										</c:forEach>
									</tbody>
