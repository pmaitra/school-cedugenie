						...
						<div class="col-md-6 col-md-offset-3">	
                            ...
                            <section class="panel">
                                <header class="panel-heading">
                                    ...
                                    <h2 class="panel-title">Inactive Subject Group</h2>
                                </header>
                                        ...
                                        <tbody>
                                           <c:forEach var="subjectGroup"  items="${subjectGroupList}" varStatus="i">
	                                                <tr>
 	                                                    ...
 	                                                    <td class="actions">
															<a href="setInactiveSubjectGroup.html?subjectGroupCode=${subjectGroup.subjectGroupCode}" class="on-default remove-row" id = "delete"><i class="fa fa-trash-o"></i></a>
														 </td>
	                                                </tr>
	                                              </c:forEach> 
                                        </tbody>
