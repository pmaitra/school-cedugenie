	...
	$(".roleChange").each(function(){		
		$(this).click(function(){
			...
			if(roleName!=''){					
				...
				$( "#administratorNavigation" ).submit();
				}	
		});
  }); 
...
<form id="administratorNavigation" name="administratorNavigation" action="changeRoleForUser.html" method="post">		
<!-- End Of modal content -->
    ...
    <section class="bodyarea">    
        ...
        <article class="leftcon">        
			...
			<div class="arrowlistmenu">
                ...
                <a href="notificationPage.html" target="_self" style="color: yellow; font-weight: bolder; text-decoration: none; "><h3 class="menuheader" style="background:url('/icam/images/a.jpg');">
                <i class="icon icon-home"></i>&nbsp;&nbsp;<span style="color:white;">HOME -> </span> <span style="color:#9fda58;font-size: 11px;">System Administration</span></h3></a>
                
                
                <h3 class="menuheader expandable">Roles</h3>
                ...
                <h3 class="menuheader expandable">Access Type</h3>
                <ul class="categoryitems">
                ...
                <h3 class="menuheader expandable">User Group</h3>
                <ul class="categoryitems">
                ...
                <h3 class="menuheader expandable">Configure Approvers</h3>
                <ul class="categoryitems">
                ...
                <h3 class="menuheader expandable">Configure Servers</h3>
                <ul class="categoryitems">
                ...
                <h3 class="menuheader expandable">Logging-Notification SetUp </h3>
                <ul class="categoryitems">  
					...
					<li><a href="getLoggingNotificationSetUp.html?module=INVENTORY" target="frame">House Master</a></li>							
					<li><a href="getLoggingNotificationSetUp.html?module=OFFICE ADMINISTRATION" target="frame">General Section</a></li>						
				</ul>
                              
                <h3 class="menuheader expandable">SLA</h3>
                 <ul class="categoryitems">
					<li><a href="viewSLAForTicketing.html" target="frame">Set Up SLA For Ticketing</a></li>										
                </ul> 
                
                 <h3 class="menuheader expandable">Manage User Password</h3>
	                <ul class="categoryitems">
	                 <li><a href="createAndUpdateUserPassword.html" target="frame">Create / Update User Password</a></li>
	               </ul>
                
<!--                 <h3 class="menuheader expandable">Archiving & Purging</h3> -->
<!--                  <ul class="categoryitems"> -->
<!-- 					<li><a href="archiveRecord.html" target="frame">Archive Record</a></li>									 -->
<!-- 					<li><a href="purgeRecord.html" target="frame">Purge Record</a></li>	 -->
<!-- 					<li><a href="readArchivedData.html" target="frame">Read Archived Data</a></li>										 -->
<!--                 </ul> -->
    <!-- 
				
				<h3 class="menuheader expandable">Department</h3>
                <ul class="categoryitems">
					<li><a href="viewDepartment.html" target="frame">Create And Edit Department</a></li>
                </ul>
                
                <h3 class="menuheader expandable">Previous Data</h3>
                 <ul class="categoryitems">
                ...
                <h3 class="menuheader expandable">Inactive Record(s)</h3>
                 <ul class="categoryitems">
					<li><a href="inactiveCourse.html" target="frame">Inactive Course</a></li>
					<li><a href="inactiveStudent.html" target="frame">Inactive Student</a></li>					
					<li><a href="inactiveStaff.html?resourceType=TEACHER" target="frame">Inactive Teacher Staff</a></li>
					...
					<li><a href="inactiveSubject.html" target="frame">Inactive Subject</a></li>
        ...
        <aside class="rightcon"> 
            ...
            <div class="innercon">            
            	<div class="boxcon">
					<iframe src="administratorProcessFlow.html" name="frame" id="frame" onload='javascript:resizeIframe(this);'>
...
<!--Individual Chat Box Body -->		
	...
	<!--footer start-->    
    <footer>
   &copy; <a href="google.com" target="_blank" style="font-weight: bolder; color: orange;">
