...
function validate(){
	...
	if(userGroupName=="null" || userGroupName==""){
		document.getElementById("warningbox").style.visibility='visible';
		document.getElementById("warningmsg").innerHTML="Please Provide User Group Name";
		return false;
	}
...
<div class="ttlarea">	
	<h1>
		<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;Create User Group
	</h1>
</div>
...
<form method="POST" action="insertUserGroup.html">
	...
	<table cellspacing="0" cellpadding="0" class="midsec">		
		<tr>
			<th>User Group Name <img class="required" src="/icam/images/required.gif" alt="Required"> </th>
			<td>
				<input type="text" class="textfield1" name="userGroupName" id="userGroupName">
			</td>
		</tr>
		<tr>
			<th>User Group Description <img class="required" src="/icam/images/required.gif" alt="Required"> </th>
			<td>
				<textarea  class="txtarea" name="userGroupDesc" id="userGroupDesc" > </textarea>
			</td>
		</tr>
		<tr>
