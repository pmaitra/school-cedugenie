...
<link href="/cedugenie/css/common/messagebox.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="/cedugenie/css/backoffice/showAssignedEvent.css" />

<!-- Calender (Existing fom old)-->
<script type="text/javascript" src="/cedugenie/js/common/jquery-1.9.1.min.js"></script>
<script src='/cedugenie/js/common/jquery-ui-1.10.2.custom.min.js'></script>
<script src='/cedugenie/js/common/fullcalendar.min.js'></script>
...
<link href='/cedugenie/css/common/calendar/fullcalendar.css' rel='stylesheet' />
<link href='/cedugenie/css/common/calendar/fullcalendar.print.css' rel='stylesheet' media='print' />
<!-- Calender -->

<script type="text/javascript" src="/cedugenie/js/backoffice/showAssignedEvent.js"></script>
...
<div class="ttlarea">	
	<h1>
		<img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp;Show And Update Assigned Event
	</h1>
</div>
