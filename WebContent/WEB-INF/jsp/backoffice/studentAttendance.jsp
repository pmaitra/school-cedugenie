...
function validate(){
	...
	else if(course == ""||course =='null'|| course==0){
		document.getElementById("javascriptmsg").style.display = 'block';			
		document.getElementById("javascriptmsg").innerHTML = "Please Enter Programme";
		
		return false;
	}
	
	else if(batch == ""||batch =='null'|| batch==0){
		document.getElementById("javascriptmsg").style.display = 'block';			
		document.getElementById("javascriptmsg").innerHTML = "Please Enter batch";
...
<body>
	<div class="alert alert-danger" id="javascriptmsg" style="display: none">
			...
			<div class= "row" >	
			<form method="POST" action="studentAttendanceUpload.html" enctype="multipart/form-data">
				
				<c:if test="${uploadStatus eq 'fail'}">
					<div class="alert alert-success">
					<strong>${uploadErrorMessage}</strong>
				</div>
				</c:if>
				<c:if test="${uploadStatus eq 'success'}">
				<div class="alert alert-success">
					<strong>${uploadErrorMessage}</strong>
				</div>
				</c:if>
	                  ...
	                  <div style="display: block;" class="panel-body">
	                      ...
	                      <div class="col-md-6">
							...
							<div class="form-group">
                                  <label class="control-label">Programme<span class="required" aria-required="true">*</span></label>
                                  	<select class="form-control" id="course" name="course" onchange="getAssignmentFolderNames(this, 'courseDir');" disabled required >
                                  		<option value="0">Select</option>
					 	...
					 	<div class="col-md-6">
							<div class="form-group">
                                         ...
                                         <select class="form-control" id="batch" name="batch" onchange="getDetails()" disabled required>
                                         	<option value="0">Select</option>
                                         </select>
                                     </div>
						</div> 
