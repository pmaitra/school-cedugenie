...
<body>
					 ...
					 <div class="row">
						...
						<div class="col-md-6 col-md-offset-3">
						  <form:form name="submitITSectionRebateAmountLimit" action="submitITSectionRebateAmountLimit.html" method="POST">
								<section class="panel">
									<header class="panel-heading">
										<div class="panel-actions">
											<a href="#" class="panel-action panel-action-toggle" data-panel-toggle=""></a>
										</div>
										<h2 class="panel-title">Create Rebate Amount</h2>										
									</header>
...
<script type="text/javascript">
	...
	//		        									alert("@@ secDetailName --> "+arr4[j]);
			        									...
			        									sm = sm + "<input type='hidden' name='"+secSplit[0]+"' value='"+rebateSplit[0]+"' >" +
			        											"<tr><td>"+rebateSplit[1]+"</td><td><input type='text' class='form-control' id='secDetailAmount"+j+"' name='"+rebateSplit[0]+"' required></td></tr>";		        									
			        								}
			        							}
