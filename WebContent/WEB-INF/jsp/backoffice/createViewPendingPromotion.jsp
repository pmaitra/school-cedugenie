...
<link rel="stylesheet" href="/cedugenie/css/backoffice/createViewPendingPromotion.css" />
...
<body>
<div class="ttlarea">	
	<h1><img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp;Pending Promotion List
	</h1>
</div>
<c:choose>	
	<c:when test="${pendingList eq null || empty pendingList}">
		<div class="btnsarea01" >
			<div class="errorbox" id="errorbox" style="visibility: visible;">
				<span id="errormsg">All Standards Promoted</span>	
			</div>
		</div>
	</c:when>
	<c:otherwise>
