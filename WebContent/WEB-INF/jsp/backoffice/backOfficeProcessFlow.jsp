...
<article style="margin-left:12%;margin-top:5%;">
    <span id="proceeFlowHeader">General Section Process Flow</span>
    <div class="simpleLens-gallery-container" id="demo-1">
        <div class="simpleLens-container">
            <div class="simpleLens-big-image-container">
                <a class="simpleLens-lens-image" data-lens-image="/cedugenie/images/BackOfficeFlowDiagram.png">
                    <img src="/cedugenie/images/BackOfficeFlowDiagram.png" class="simpleLens-big-image">
                </a>
            </div>
        </div>        
    </div>
