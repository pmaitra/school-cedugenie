...
<!-- End Of modal content -->
<form id="hostelNavigation" name="hostelNavigation" action="changeRoleForUser.html" method="post">
    ...
    <section class="bodyarea">    
        ...
        <article class="leftcon">        
			...
			<div class="arrowlistmenu">
                <a href="notificationPage.html" target="_self" style="color: yellow; font-weight: bolder; text-decoration: none; "><h3 class="menuheader" style="background:url('/icam/images/a.jpg');"><i class="icon icon-home"></i>&nbsp;&nbsp;<span style="color:white;">HOME -> </span> <span style="color:#9fda58">Hostel</span></h3></a>
				...
				<c:if test="${i eq 1}">
                <h3 class="menuheader expandable">Hostel Setup</h3>
        ...
        <aside class="rightcon"> 
            ...
            <div class="innercon">            
            	<div class="boxcon">
					<iframe src="hostelProcessFlow.html" name="frame" id="frame" onload='javascript:resizeIframe(this);'>
