	...
	<header class="page-header">
		...
		<c:if test="${updateResponse eq 'fail'}">
			<div class="alert alert-danger" >
				...
				<div class="row">
					<div class="col-md-12">
					 	<form method="POST" action="inactiveForMailSentBox.html">
						 <section class="panel">
							<header class="panel-heading">
                                <h2 class="panel-title">SentBox(${emailNotification.newNotification})</h2>
							</header>
							<div class="panel-body">
								<table class="table mb-none" id="datatable-tabletools ">
									...
									<tbody>
										<c:forEach var="emailDetails" items="${sentEmailDetailsList}">			
										<tr>
											 <td>
...
{
	window.location="emailContentForSentItems.html?emailId="+emailCode;
