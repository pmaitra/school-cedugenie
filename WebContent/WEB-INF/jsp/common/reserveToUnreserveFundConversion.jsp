...
<title>Reserve To Unreserve Fund Conversion</title>
...
<body>
		...
		<header class="page-header">
			<h2>Reserve To Unreserve Fund Conversion</h2>
		</header>
		<div class="content-padding">
			...
			<div class="row">
				<div class="col-md-12">
					<form:form name="libraryPolicy"  method="POST" action="submitReserveToUnreserveFund.html">
						<section class="panel">
							<header class="panel-heading">
								<div class="panel-actions">
									<a href="#" class="panel-action panel-action-toggle" data-panel-toggle=""></a>
								</div>
								<h2 class="panel-title">Reserve To Unreserve Fund Conversion For ${department}</h2>										
							</header>
								...
								<div class="row">            
									<div class="col-md-6 col-md-offset-3">                                                            
										...
										<div class="form-group">
											...
											<div>
												<input type="hidden" id="resFund" name="resFund" class="form-control" value="${budgetDetails.reserveFund}">
												<input id="reserveFund" name="reserveFund" class="form-control" value="${budgetDetails.reserveFund}" type="text" readonly="readonly">
											</div>
										</div>
										<div class="form-group" id="conversionDiv">
											<div class="col-md-7">
												<label class="control-label">Dedicated Amount</label>
												<div>
													<input id="dedicatedAmount" name="dedicatedAmount" class="form-control" type="text">
												</div>
											</div>
											<div class="col-md-5">
												<button type="button" class="btn btn-success" id="convertToUnreserve" onclick="calculateTotalUnreserve();">Convert To Unreserve</button>
											</div>
										</div>
										<div id="errorMessageDiv" class="alert alert-danger" style="display: none">
							          		<p align="center">
							          			<strong>Dedicated Amount Can Not Be Greater Than Reserved Amount</strong>
							          		</p>
							          	</div>
							          	<div id="messageDiv" class="alert alert-danger" style="display: none">
							          		<p align="center">
							          			<strong>No Available Reserve Fund</strong>
							          		</p>
							          	</div>
									</div>
								</div>
...
<script type="text/javascript" src="/cedugenie/js/common/reserveToUnreserveFundConversion.js"></script>
