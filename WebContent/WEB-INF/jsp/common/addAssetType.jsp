...
<link rel="stylesheet" href="/icam/css/common/assetType.css" />
...
<script type="text/javascript" src="/icam/js/common/assetType.js"></script>

</head>
<body>
	<div class="ttlarea">	
		<h1>
			<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;Add Asset Type
		</h1>
	</div>
	...
	<form:form name="submitAssetType" action="submitAssetType.html" method="POST">		
		...
		<table cellspacing="0" cellpadding="0" class="midsec" border="1">		
			...
			<tr>
				<th>
					Enter Asset Type Name<img class="required" src="/icam/images/required.gif" alt="Required">
				</th>
				<td>
