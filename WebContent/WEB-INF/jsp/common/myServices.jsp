...
<%-- 					<li><a href="taskDelegation.html?id=${sessionScope.sessionObject.userId}" target="frame">Task Delegation</a></li> --%>
					<li><a href="generateTicket.html" target="frame">Generate Ticket</a></li>
					<li><a href="listTicket.html" target="frame">Outward Open Ticket List</a></li>
				</ul>
...
<!--                 <ul class="categoryitems"> -->
<!-- 					<li><a href="viewDeclarationForm.html" target="frame">Income Tax Dec&thinsp;laration Form</a></li>					 -->
<%--                 	<li><a href="viewCheckTaxDeduct.html?id=${sessionScope.sessionObject.userId}" target="frame">Tax Deduction Month-Wise</a></li> --%>
<%-- 					<li><a href="viewCustomizedPF.html?id=${sessionScope.sessionObject.userId}" target="frame">Customize Provident Fund</a></li> --%>
<!-- 					<li><a href="taxAssumption.html" target="frame">Tax Assumption</a></li>	 -->
<!--                 </ul>                  -->
                <h3 class="menuheader expandable">Leave Management</h3>
                <ul class="categoryitems">
					<li><a href="leaveRequest.html" target="frame">Request for Leave</a></li>					
<!-- 					<li><a href="listTaskHistory.html" target="frame">Leave History</a></li> -->
					<li><a href="listPersonalLeaveHistory.html" target="frame">Leave History</a></li>
                </ul>
<!--                 <h3 class="menuheader expandable">Personal Calender</h3> -->
<!--                 <ul class="categoryitems"> -->
...
<!-- 				</ul> -->
<!--                 <h3 class="menuheader expandable">View Delegated Task</h3> -->
<!--                 <ul class="categoryitems"> -->
...
<!--                 </ul>	 -->
        ...
        <aside class="rightcon"> 
            ...
            <div class="innercon">            
            	<div class="boxcon">
					<iframe  name="frame" id="frame" onload='javascript:resizeIframe(this);'>
