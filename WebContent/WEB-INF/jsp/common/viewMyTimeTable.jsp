...
<script type="text/javascript" src="/cedugenie/js/common/viewMyTimeTable.js"></script>
					...
					<section class="panel">
						<header class="panel-heading">
							...
							<label>Time-Table For :</label> 
								<select class="form-control" name="semsterName" id="semsterName" style="width:200px" onchange="viewMyTimeTableData()">
