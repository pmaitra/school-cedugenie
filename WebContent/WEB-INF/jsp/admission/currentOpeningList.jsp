	                                ...
	                                <header class="panel-heading">
	                                	...
	                                	<div class="panel-body">
			                                    <table id="datatable-tabletools" class="table table-bordered table-striped mb-none">
			                                        ...
			                                        <tbody>
			                                        	<c:forEach var="admissionFormlist" items="${admissionFormList}">
															<tr >
																<td>
																	<c:out value="${admissionFormlist.admissionFormYear}"></c:out>
																</td>
																<%-- <td><c:out value="${admissionFormlist.courseClass}"></c:out></td> --%>
																<td><c:out value="${admissionFormlist.courseName}"></c:out></td>
																<td><c:out value="${admissionFormlist.admissionDriveName}"></c:out></td>
