...
<div class="ttlarea">	
		<h1>
		<img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp;Create Purchase Order
		</h1>
</div>
...
<c:choose>
		<c:when test="${messVendorList eq null}">
			<div class="btnsarea01" style="visibility: visible;">
				<div class="errorbox" id="errorbox" style="visibility: visible;">
					<span id="errormsg">No Vendor Details Found</span>	
				</div>
			</div>
		</c:when>
<c:otherwise>
  <form action="getPurchaseOrderReport.html" method="post">
	<table cellspacing="0" cellpadding="0" class="midsec">
		<tr>
			<th>Vendor Name :: <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
			<td>
					<select name="vendor.vendorCode" id="vendorCode" class="defaultselect" >
						<option value="">Select...</option>
						<c:forEach var="vendor" items="${messVendorList}">
  	 	...
  	 	<tr>
				<th  style="text-align: center;">Please Select Date</th>
				<td><input type="text" id="startDate" name="orderOpenDate" class="textfield1"></td>			
		</tr>		
	</table>
	<br/>
