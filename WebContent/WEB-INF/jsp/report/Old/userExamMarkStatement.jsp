...
<title>User Exam Marks Statement</title>
...
<div class="ttlarea">	
	<h1>
		<img src="/icam/images/titleicon01.png" alt="" />&nbsp;&nbsp;User Exam Mark Statement
	</h1>
</div>
...
<c:choose>
	...
	<c:otherwise>
	  <form action="getStudentReportFORXI_XII.html" method="post">
