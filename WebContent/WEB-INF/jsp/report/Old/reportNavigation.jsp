...
<meta name="description" content="Reporting Navigation" />
<meta name="keywords" content="Menu For Reporting Module" />
<meta name="revisit-after" content="7 days" />
<meta name="robots" content="index,follow" />
<title>Reporting Navigation</title>
...
<form id="reportingNavigation" name="reportingNavigation" action="changeRoleForUser.html" method="post">
    ...
    <section class="bodyarea">    
        ...
        <article class="leftcon">        
			...
			<div class="arrowlistmenu">
                <a href="notificationPage.html" target="_self" style="color: yellow; font-weight: bolder; text-decoration: none; "><h3 class="menuheader" style="background:url('/icam/images/a.jpg');"><i class="icon icon-home"></i>&nbsp;&nbsp;<span style="color:white;">HOME -> </span> <span style="color:#9fda58">Report</span></h3></a>    
                                
                <h3 class="menuheader expandable">Academic Report</h3>
                ...
                <h3 class="menuheader expandable">General Report</h3>
		                <ul class="categoryitems">
		   	...
		   	<c:if  test="${(fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'super admin')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'admission administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'report administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'principal')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'headmaster'))}" >    
		        <h3 class="menuheader expandable">Admission Report</h3>
                <ul class="categoryitems">
             ...
             <c:if  test="${(fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'super admin')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'inventory administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'report administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'principal')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'headmaster'))}" >  
...
<!-- 							<li><a href="" target="frame">ASTB Report</a></li>				 -->
		        </ul>
              </c:if>
              
               <c:if  test="${(fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'super admin')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'mess administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'report administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'principal')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'headmaster'))}" > 
...
<%-- 		        <c:if  test="${(fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'super admin')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'library administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'report administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'principal')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'headmaster'))}" > --%>
<!-- 		         <h3 class="menuheader expandable">Library</h3> -->
<!-- 		                <ul class="categoryitems"> -->
<!-- 							<li><a href="" target="frame">ASTB Report</a></li> -->
<!-- 							<li><a href="" target="frame">Book Allocation Report</a></li>					 -->
<!-- 		        </ul> -->
<%-- 		        </c:if> --%>
		        
<%-- 		        <c:if  test="${(fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'super admin')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'finance administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'report administrator')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'principal')) || (fn:containsIgnoreCase(sessionScope.sessionObject.currentRoleOrAccess, 'headmaster'))}" > --%>
<!-- 		         <h3 class="menuheader expandable">Finance</h3> -->
<!-- 		                <ul class="categoryitems"> -->
<!-- 							<li><a href="" target="frame"></a></li>					 -->
<!-- 		        </ul> -->
<%-- 		        </c:if> --%>
