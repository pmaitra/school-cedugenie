...
<body>
		...
		<div class="row">
						<div class="col-md-6 col-md-offset-3">
						  <form action="getcertificate.html" method="post" class="form-horizontal">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Certificate </h2>										
									</header>
...
<script type="text/javascript" src="/cedugenie/js/report/userExamMarkStatement.js"></script>
</body>
