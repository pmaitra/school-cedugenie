...
<script type="text/javascript" src="/cedugenie/js/report/studentMarksheet.js"></script>
</head>
<body>
<div class="ttlarea">	
		<h1>
		<img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp;Student Result
		</h1>
</div>
...
<c:otherwise>
  <form action="getStudentReport.html" method="post">
