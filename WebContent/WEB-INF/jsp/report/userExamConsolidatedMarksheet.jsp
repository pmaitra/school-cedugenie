...
<title>User Exam Consolidated Mark sheet</title>
<link rel="stylesheet" href="/cedugenie/css/report/userExamMarkStatement.css" />
...
<script type="text/javascript" src="/cedugenie/js/report/userExamConsolidatedMarksheet.js"></script>
</head>
<body>
<div class="ttlarea">	
	<h1>
		<img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp;User Exam Consolidated Mark sheet
	</h1>
</div>
...
<c:choose>
	...
	<c:otherwise>
	  <form action="getConsolidatedResultForXII_XII.html" method="post">
		...
		<div class="btnsarea01">
			...
			<input type="submit" id="submitGradePoint" name="submitGradePoint" value="Consolidated Report" onclick="return validateForm();" class="submitbtn" />
