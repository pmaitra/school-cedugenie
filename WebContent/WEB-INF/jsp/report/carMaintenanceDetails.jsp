...
<div class="ttlarea">	
		<h1>
		<img src="/cedugenie/images/titleicon01.png" alt="" />&nbsp;&nbsp;Car Maintenance Report
		</h1>
</div>
...
<c:choose>
		<c:when test="${carList eq null}">
			<div class="btnsarea01" style="visibility: visible;">
				<div class="errorbox" id="errorbox" style="visibility: visible;">
					<span id="errormsg">No Car Details Found</span>	
				</div>
			</div>
		</c:when>
<c:otherwise>
  <form action="getCarMaintenanceReport.html" method="post">
	<table cellspacing="0" cellpadding="0" class="midsec">
		<tr>
			<th>Car :: <img class="required" src="/cedugenie/images/required.gif" alt="Required"></th>
			<td>
					<select name=carDetailsCode id="carNameId" class="defaultselect" >
