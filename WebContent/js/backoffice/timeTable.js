...
var defaults = {
	...
	dayNamesShort: ['Duration','MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT'],
	buttonText: {
...
-----------------------------------------------------------------------------*/
//madhu change 1
var dayIDs = ['Day 1', 'Day 2', 'Day 3', 'Day 4', 'Day 5','Day 6'],
	DAY_MS = 86400000,
	HOUR_MS = 3600000,
	MINUTE_MS = 60000;
...
// madhu days
		/*if (showWeekNumbers) {
			...
			///change sayani 2
			s += "<th class='fc-agenda-axis " + headerClass + "'>sayani&nbsp;</th>";
			
		}*/
//div css sayani
		for (i=0; i<colCnt+1; i++) {
			s +=
				"<th style='width: 120px;' class='fc- fc-col" + i + ' ' + headerClass + "'>No.</th>"; // fc- needed for setDayID
		}
		s +=
		...
		for (i=0; i<colCnt; i++) {
			s +=
				...
				"<div style='position:relative'>Day&nbsp;</div>" +
				"</div>" +
				"</div>" +
				"</td>";
		}
		...
		//change sayani 3 ghochu
			//alert("slotNormal"+slotNormal);
			//+
			//((!slotNormal || !minutes) ? formatDate(d, opt('axisFormat')) : '&nbsp;') +
			
			//"<th class='fc-agenda-axis " + headerClass + "'></th>" +
			//Period  <b>Period "+slotCnt1+"</b>
			s +=
				"<tr class='fc-slot" + i + ' ' + (!minutes ? '' : 'fc-minor') + "'>" +

				"<td class='" + contentClass + "' >" +
				"<div style='position:relative;height:50px;width:100%;'>"+slotCnt1+"</div>" +    //change sayani the size of time table
				"</td>" +
				"</tr>";
	...
	function timePosition(day, time) { // both date objects. day holds 00:00 of current day
		...
		/*	alert("minutes another"+minutes);
		alert("time.getHours() another"+time.getHours());*/
	...
	function renderSlotSegs(segs, modifiedEventId) {
		...
		for (i=0; i<segCnt; i++) {
			...
			if (eventElement = seg.element) {
				...
				eventElement[0].style.height = 50 + 'px'; //change the event size "51"
				event = seg.event;
