		     ...
		     success: function(data) {
		    	if(data != null && data!= ""){
		    		document.getElementById("warningbox").style.visibility='visible';
		 			$("#warningbox").text("Venue already exists");	
	...
	function makeEditableCreateExamVenueForm(){
		document.getElementById("venue").removeAttribute("readonly");
		document.getElementById("contactNo").removeAttribute("readonly");
		...
		document.getElementById("presentAddress1").removeAttribute("readonly");
