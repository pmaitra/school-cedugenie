$("#course").change(function (){
	...
	$("#subject").change(function (){
		document.getElementById("exam").removeAttribute("disabled");
			...
			$("#exam").change(function (){
				...
				success: function(allData) {
					...
					var status=allData[allData.length-1];
		        	document.getElementById("insertUpdate").value=status;
		        	var check=0;
		        	var tester=allData[0].split("*~*");
		        	if(tester[2]!="0"){
		        		tableHead.innerHTML="<tr><th>Sl. No.</th><th>Roll Number(Name)</th><th>Theory(Pass)</th><th>Practical(Pass)</th><th>Total(Pass)</th><th>Status</th></tr>";
		        	}else{
		        		tableHead.innerHTML="<tr><th>Sl. No.</th><th>Roll Number(Name)</th><th>Theory(Pass)</th><th>Total(Pass)</th><th>Status</th></tr>";
		        		check=1;
		        	}
		...
		function calculateMarks(box){	
			...
			//document.getElementById("submit".revomeAttribute("disa"))
		}
